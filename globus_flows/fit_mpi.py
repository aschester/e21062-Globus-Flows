...
##
# @file fit_mpi.py
# @brief Compute function to fit traces in an FRIBDAQ event file using
# containerized MPI parallelism. Run from inside the virtual environment
# where the Globus Compute Python SDK is installed.
#
# For help/usage: python ./fit_mpi.py --help
#
...
for s in args.segments:
    batch.add(function_id=function_id, args=(input_path, args.output_path, args.run, s))
